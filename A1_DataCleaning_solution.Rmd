...
```{r}
Demo <- read_csv("/Users/au598019/Dropbox/Teaching/2020 methods 3/Assignments20/Assignment1/data/demo_train.csv")
getwd()
LU <- read_csv('/Users/au598019/Dropbox/Teaching/2020 methods 3/Assignments20/Assignment1/data/LU_train.csv')
Word <- read_csv('/Users/au598019/Dropbox/Teaching/2020 methods 3/Assignments20/Assignment1/data/token_train.csv')
```
...
```{r}
Data %>% filter(CHI_MLU > 2.7)
Data %>% filter(CHI_MLU > 1.5 & Visit == 1) #does this work?
```
...
Data %>% filter(Diagnosis == "ASD") %>%
  select(Diagnosis, CHI_MLU, CHI_MLU, tokens_CHI)
```
